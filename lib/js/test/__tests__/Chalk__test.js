...
Jest.describe("Chalk Bindings", (function (param) {
        Jest.test("'Chalk.level' returns 'Some(level)'", (function (param) {
                ...
                return Jest.ExpectJs.toBe(true, Jest.ExpectJs.expect(Belt_Option.isSome(lvl)));
              }));
        ...
        Jest.test("Color support level is parsed correctly", (function (param) {
        ...
        Jest.test("Chalk.rgb", (function (param) {
                var result = Belt_Result.getWithDefault(Chalk__TestUtils.tryCatch(function (param) {
                          ...
                          for(var _for = 1; _for <= 10000; ++_for){
                            var r = Curry._1(Chalk__TestUtils.Rand.bool, undefined) ? Chalk__TestUtils.Rand.$$int(undefined) : -Chalk__TestUtils.Rand.$$int(undefined) | 0;
                            var g = Curry._1(Chalk__TestUtils.Rand.bool, undefined) ? Chalk__TestUtils.Rand.$$int(undefined) : -Chalk__TestUtils.Rand.$$int(undefined) | 0;
                            var b = Curry._1(Chalk__TestUtils.Rand.bool, undefined) ? Chalk__TestUtils.Rand.$$int(undefined) : -Chalk__TestUtils.Rand.$$int(undefined) | 0;
        ...
        Jest.test("Chalk.hex", (function (param) {
                var result = Belt_Result.getWithDefault(Chalk__TestUtils.tryCatch(function (param) {
                          var arr = [];
                          for(var _for = 1; _for <= 10000; ++_for){
                            var hexValue = Chalk__TestUtils.Rand.string(0, 100);
        ...
        Jest.test("Chalk.keyword", (function (param) {
                var result = Belt_Result.getWithDefault(Chalk__TestUtils.tryCatch(function (param) {
                          ...
                          Belt_Array.forEachU(Chalk__TestUtils.keywordArray, (function (kw) {
                                  var style = Chalk.keyword(Chalk$1, kw);
                                  arr.push($$eval(style));
        ...
        Jest.test("Chalk.hsl", (function (param) {
                var result = Belt_Result.getWithDefault(Chalk__TestUtils.tryCatch(function (param) {
                          var arr = [];
                          for(var _for = 1; _for <= 10000; ++_for){
                            var h = Curry._1(Chalk__TestUtils.Rand.bool, undefined) ? Chalk__TestUtils.Rand.$$int(undefined) : -Chalk__TestUtils.Rand.$$int(undefined) | 0;
                            var s = Curry._1(Chalk__TestUtils.Rand.bool, undefined) ? Chalk__TestUtils.Rand.$$int(undefined) : -Chalk__TestUtils.Rand.$$int(undefined) | 0;
                            var l = Curry._1(Chalk__TestUtils.Rand.bool, undefined) ? Chalk__TestUtils.Rand.$$int(undefined) : -Chalk__TestUtils.Rand.$$int(undefined) | 0;
        ...
        Jest.test("Chalk.hsv", (function (param) {
                var result = Belt_Result.getWithDefault(Chalk__TestUtils.tryCatch(function (param) {
                          ...
                          for(var _for = 1; _for <= 10000; ++_for){
                            var h = Curry._1(Chalk__TestUtils.Rand.bool, undefined) ? Chalk__TestUtils.Rand.$$int(undefined) : -Chalk__TestUtils.Rand.$$int(undefined) | 0;
                            var s = Curry._1(Chalk__TestUtils.Rand.bool, undefined) ? Chalk__TestUtils.Rand.$$int(undefined) : -Chalk__TestUtils.Rand.$$int(undefined) | 0;
                            var v = Curry._1(Chalk__TestUtils.Rand.bool, undefined) ? Chalk__TestUtils.Rand.$$int(undefined) : -Chalk__TestUtils.Rand.$$int(undefined) | 0;
        ...
        Jest.test("Chalk.hwb", (function (param) {
                var result = Belt_Result.getWithDefault(Chalk__TestUtils.tryCatch(function (param) {
                          ...
                          for(var _for = 1; _for <= 10000; ++_for){
                            var h = Curry._1(Chalk__TestUtils.Rand.bool, undefined) ? Chalk__TestUtils.Rand.$$int(undefined) : -Chalk__TestUtils.Rand.$$int(undefined) | 0;
                            var w = Curry._1(Chalk__TestUtils.Rand.bool, undefined) ? Chalk__TestUtils.Rand.$$int(undefined) : -Chalk__TestUtils.Rand.$$int(undefined) | 0;
                            var b = Curry._1(Chalk__TestUtils.Rand.bool, undefined) ? Chalk__TestUtils.Rand.$$int(undefined) : -Chalk__TestUtils.Rand.$$int(undefined) | 0;
        ...
        Jest.test("Chalk.ansi", (function (param) {
                var result = Belt_Result.getWithDefault(Chalk__TestUtils.tryCatch(function (param) {
                          var arr = [];
                          for(var _for = 1; _for <= 10000; ++_for){
                            var ansiValue = Curry._1(Chalk__TestUtils.Rand.bool, undefined) ? Chalk__TestUtils.Rand.$$int(undefined) : -Chalk__TestUtils.Rand.$$int(undefined) | 0;
        ...
        Jest.test("Chalk.ansi256", (function (param) {
                var result = Belt_Result.getWithDefault(Chalk__TestUtils.tryCatch(function (param) {
                          var arr = [];
                          for(var _for = 1; _for <= 10000; ++_for){
                            var ansi256Value = Curry._1(Chalk__TestUtils.Rand.bool, undefined) ? Chalk__TestUtils.Rand.$$int(undefined) : -Chalk__TestUtils.Rand.$$int(undefined) | 0;
        ...
        Jest.test("Chalk.bgKeyword", (function (param) {
                var result = Belt_Result.getWithDefault(Chalk__TestUtils.tryCatch(function (param) {
                          var arr = [];
                          Belt_Array.forEachU(Chalk__TestUtils.keywordArray, (function (kw) {
                                  var style = Chalk.bgKeyword(Chalk$1, kw);
                                  arr.push($$eval(style));
